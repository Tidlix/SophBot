...
namespace SophBot.Commands.ModCommands {
    ...
    public class RuleCommands {
        ...
        public async ValueTask sendRules(SlashCommandContext ctx)
        {
                ...
                modal.AddTextInputComponent(new DiscordTextInputComponent(label: $"Beschreibung:", customId: $"ruleDescription", max_length: 1000, style: DiscordTextInputStyle.Paragraph));
